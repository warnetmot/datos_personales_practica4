...
using datos_personales.Models;

namespace datos_personales.Controllers
{
    public class DatosPersonalesController : Controller
    {
        private readonly TiendaComercialContext _context;

        public DatosPersonalesController(TiendaComercialContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,ApellidoPaterno,ApellidoMaterno,Telefono,Carnet,Expededo,Direccion")] DatosPersonale datosPersonale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,ApellidoPaterno,ApellidoMaterno,Telefono,Carnet,Expededo,Direccion")] DatosPersonale datosPersonale)
        {
